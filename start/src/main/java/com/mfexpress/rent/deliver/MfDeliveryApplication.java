...
@SpringBootApplication(scanBasePackages = {"com.mfexpress.rent.deliver", "com.mfexpress.rent.vehicle.fallback", "com.mfexpress.order.fallback","com.mfexpress.billing.rentcharge.fallback"
        , "com.mfexpress.transportation.customer.fallback", "com.mfexpress.common.domain.api.fallback", "com.mfexpress.billing.customer.fallback", "com.hx.backmarket.maintain.api.domain.fallback"})
