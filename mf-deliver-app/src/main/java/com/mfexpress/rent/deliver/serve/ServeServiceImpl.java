...
public class ServeServiceImpl implements ServeServiceI {
    ...
    @Resource
    private TerminationServeExecute terminationServeExecute;
    ...
    @Override
    public Boolean terminationService(TerminationServiceCmd terminationServiceCmd, TokenInfo tokenInfo) {
        return terminationServeExecute.execute(terminationServiceCmd, tokenInfo);
    }
}
